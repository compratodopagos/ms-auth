import styles from './RegisterPasswordStep.module.css';
...
const RegisterPasswordStep = () => {
    ...
    const [confirmInputPassword, setConfirmInputPassword] = useState<string>('');
    const [error, setError] = useState<Record<string, boolean>>({ uncheck: true });
    ...
    const validPass = (password: string, confirmPassword: string) => {
